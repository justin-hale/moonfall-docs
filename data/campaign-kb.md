...
|----------|-----------------|-------------------|-------|
| High Forge | High Forge | "Highforge" | Primary campaign city |
| Greyport | Greyport | "Grayport", "Grey Port" | Coastal city |
| Eldoran Empire | Eldoran | "Elderan" | Imperial capital and empire |
...
These are systematic speech-to-text mistakes that appear in generated notes:
...
- **Pocket village**: Now collapsible capsule form. Elspeth built it; party uses it for rest/recovery.
- **Goblin Enclave**: Next destination after Greyport. Introduced via Lady Viper.
- **Luna connection**: Leliana's song forged a connection to Luna.
